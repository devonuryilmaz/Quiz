...
@Component({
  ...
  templateUrl: './video-upload-gaze-secenek4.component.html',
  styleUrls: ['./video-upload-gaze-secenek4.component.scss']
})
export class VideoUploadGazeSecenek4Component implements OnInit {
