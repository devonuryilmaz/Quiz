...
@Component({
  ...
  templateUrl: './video-upload-gaze-secenek2.component.html',
  styleUrls: ['./video-upload-gaze-secenek2.component.scss']
})
export class VideoUploadGazeSecenek2Component implements OnInit {
