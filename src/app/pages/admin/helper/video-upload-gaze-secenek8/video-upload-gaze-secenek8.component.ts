...
@Component({
  ...
  templateUrl: './video-upload-gaze-secenek8.component.html',
  styleUrls: ['./video-upload-gaze-secenek8.component.scss']
})
export class VideoUploadGazeSecenek8Component implements OnInit {
