...
@Component({
  ...
  templateUrl: './video-upload-gaze-secenek3.component.html',
  styleUrls: ['./video-upload-gaze-secenek3.component.scss']
})
export class VideoUploadGazeSecenek3Component implements OnInit {
