...
@Component({
  ...
  templateUrl: './video-upload-gaze-secenek5.component.html',
  styleUrls: ['./video-upload-gaze-secenek5.component.scss']
})
export class VideoUploadGazeSecenek5Component implements OnInit {
